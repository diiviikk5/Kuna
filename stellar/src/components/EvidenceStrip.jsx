...
const EvidenceStrip = ({
    ...
    return (
        <motion.div
            className="flex flex-wrap items-center justify-between gap-6 px-4 py-3 bg-slate-900/50 border-2 border-slate-800 font-mono shadow-[4px_4px_0px_#000]"
        ...
        >
            <div className="flex items-center gap-3">
                ...
                <span className="text-[11px] font-black text-slate-100 uppercase tracking-widest italic">MISSION_EVIDENCE // PKT_SYNC</span>
            </div>
            ...
            <div className="flex items-center gap-8">
                <div className="flex items-center gap-3 border-l-2 border-slate-800 pl-6">
                    ...
                    <span className="text-[11px] font-black text-slate-200">{validationWindow}</span>
                </div>

                <div className="flex items-center gap-3 border-l-2 border-slate-800 pl-6">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">BASELINE:</span>
                    <span className="text-[11px] font-black text-amber-500">{baselineRMSE}</span>
                </div>

                <div className="flex items-center gap-3 border-l-2 border-slate-800 pl-6">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">STELLAR_V1:</span>
                    <span className="text-[11px] font-black text-emerald-500">{stellarRMSE}</span>
                </div>

                <div className="flex items-center gap-3 border-l-2 border-slate-800 pl-6">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">GAIN:</span>
                    <span className="text-[12px] font-black text-white bg-emerald-600 px-2 shadow-[2px_2px_0px_#000]">{improvement}</span>
                </div>
            </div>
        </motion.div>
    );
